    ...
    return (
        <main>
            <Header>
                ...
                <ContainerIconeHeader>
                    <a href={sendMessageWhatsApp({ message: 'Olá, estou entrando em contato pelo site da FTX.', phoneNumber: '5511956556096'})} >
            ...
            <WitheSection>
                ...
                <ContainerButton>
                    <Button href={sendMessageWhatsApp({ message: 'Olá, estou entrando em contato pelo site da FTX.', phoneNumber: '5511956556096'})} img={{ label: 'Imagem do Icone do WhatsApp', url: ImgWhatsAppClean }} >CHAMA NO WHATS</Button>
                </ContainerButton>
            </WitheSection>
            <BlueSection>
                ...
                <ContainerFooterThirdSection>
                    <ContainerLocation>
                        ...
                        <Button href={sendMessageWhatsApp({ message: 'Olá, estou entrando em contato pelo site da FTX.', phoneNumber: '5511956556096'})} img={{ label: 'Imagem do Icone do WhatsApp', url: ImgWhatsAppClean }} >CAIEIRAS</Button>
                    </ContainerLocation>
                    <ContainerLocation>
                        <ContainerImgLocation>
                            <img src={ImgShopFranciscoMorato} alt="Imagem da Loja da FTX de Francisco Morato - SP" />
                        </ContainerImgLocation>
                        <Button href={sendMessageWhatsApp({ message: 'Olá, estou entrando em contato pelo site da FTX.', phoneNumber: '5511994352525'})} img={{ label: 'Imagem do Icone do WhatsApp', url: ImgWhatsAppClean }} >FRANCISCO MORATO</Button>
                    </ContainerLocation>
                </ContainerFooterThirdSection>
            </BlueSection>
            <WitheSection>
                ...
                <ContainerButton>
                    <Button href={sendMessageWhatsApp({ message: 'Olá, estou entrando em contato pelo site da FTX.', phoneNumber: '5511956556096'})} img={{ label: 'Imagem do Icone do WhatsApp', url: ImgWhatsAppClean }} >ESTAMOS TE ESPERANDO!</Button>
                </ContainerButton>
            </WitheSection>
            <BlueSection>
                <ContainerHeaderBlueSection>
                ...
                <ContainerButton>
                    <Button href={sendMessageWhatsApp({ message: 'Olá, estou entrando em contato pelo site da FTX.', phoneNumber: '5511956556096'})} img={{ label: 'Imagem do Icone de Avaliação', url: ImgWhatsAppClean }} >ENTRE EM CONTATO AGORA MESMO!</Button>
                </ContainerButton>
            </BlueSection>
            <WitheSection>
                <ContainerHeaderWhiteSection>
                ...
                <ContainerButton>
                    <Button href={sendMessageWhatsApp({ message: 'Olá, estou entrando em contato pelo site da FTX.', phoneNumber: '5511956556096'})} img={{ label: 'Imagem do Icone do WhatsApp', url: ImgWhatsAppClean }} >ESTÁ COM DÚVIDA? PERGUNTE PARA NÓS!</Button>
                </ContainerButton>
            </WitheSection>
            <Footer>
                <ContainerHeaderFooter>
